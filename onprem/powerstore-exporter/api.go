...
func (c *Client) GetAlerts() (string, error) {
	return c.getData("alert?select=id,severity,description_l10n,resource_type,resource_name&state=neq.CLEARED&is_acknowledged=eq.false&limit=200", "GET", "")
}
